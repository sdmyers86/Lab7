...
public class RPSLSpock {
    ...
    /**
     * @param pick user entry to pick rock, paper, scissors, lizard, or spock
     * @return true if user entry matches one of the defined class attributes
     */
    ...
    /**
     * @return random computer pick of rock, paper, scissors, lizard, or spock
     */
    ...
    /**
     * @param c_pick random computer pick
     * @param h_pick user entered pick
     * @return true if computer pick beats user pick; false if user pick beats computer pick
     */
